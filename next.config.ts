        ...
        headers: [
          {
            ...
            value:
              "default-src 'self'; connect-src 'self' http://10.0.0.151:8080 http://10.0.1.14:8080 http://10.0.0.154:8080 http://10.0.1.10:8080 http://10.0.1.6:8080; img-src *; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; font-src 'self' data:; frame-src 'self' https://www.google.com https://www.youtube.com https://www.facebook.com https://www.instagram.com https://www.linkedin.com; object-src 'none';",
          },
        ],
      },
    ];
