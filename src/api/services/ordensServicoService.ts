...
interface OSFilterParams extends Record<string, string | number | boolean | undefined> {
    nro_pagina?: number;
...
class OrdensServicoService {
    ...
    async colocarPendente(id: number, data: OSPendenciaForm): Promise<OSDetalhada> {
