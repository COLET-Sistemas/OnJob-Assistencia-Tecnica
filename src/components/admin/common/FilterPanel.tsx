...
const FilterPanel: React.FC<FilterPanelProps> = ({
  ...
  return (
    <>
      ...
      {/* Painel de filtros */}
      <div className="fixed inset-y-0 right-0 z-50 w-80 lg:w-96 transform transition-transform duration-300 ease-in-out bg-white shadow-xl h-screen overflow-hidden border-l border-gray-200/80 animate-slideInUp">
                  ...
                  {option.type === "text" && (
                    <div className="space-y-2">
                      <div className="relative">
                        ...
                        <Search
                          size={16}
                          className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 transition-colors group-focus-within:text-[var(--primary)]"
                        />
                      </div>
                      {filterValues[option.id] &&
                        filterValues[option.id].length > 0 &&
                  ...
                  {option.type === "select" && (
                    <>
                      ...
                      <div className="absolute right-4 top-1/2 transform -translate-y-1/2 pointer-events-none">
                        <svg
                          className="w-4 h-4 text-gray-400 transition-colors group-focus-within:text-[var(--primary)]"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                    ...
                    >
                      <div className="flex items-center justify-between w-full cursor-pointer">
                        ...
                        <div className="flex items-center">
                          <div
                            className={`relative w-12 h-6 flex items-center transition-all duration-200 ease-in-out ${
                              filterValues[option.id] === "true"
                                ? "bg-[var(--primary)]"
                                : "bg-gray-200"
                            } rounded-full`}
                          >
                            ...
                            />
                            <span
                              className={`absolute left-1 bg-white w-4 h-4 rounded-full transition-transform duration-200 transform ${
                                filterValues[option.id] === "true"
                                  ? "translate-x-6"
                                  : ""
          ...
          {(() => {
            ...
            return (
              <button
                ...
                className={`w-full py-3 text-sm font-medium text-white cursor-pointer ${
