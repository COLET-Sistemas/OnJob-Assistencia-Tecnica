...
/**
 * Componente memoizado para renderizar cada item na lista de maquinas
 * com informacoes adicionais como status de garantia
 */
        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex flex-wrap items-center gap-2">
              ...
              {descricao && <span className={descricaoClasses}>{descricao}</span>}
            </div>
            {showWarrantyBadge && (
              <div
