          ...
          <section className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="px-8 py-12 text-center border-b border-slate-200 bg-gradient-to-b from-slate-50 to-white">
              ...
              <p className="text-slate-600 leading-relaxed max-w-3xl mx-auto text-base">
                ...
                <strong>Ordens de Serviço retroativas</strong> atendimentos
                que já foram executados, mas ainda não constam no sistema. Essa
                ação garante um <strong>histórico completo</strong> e melhora a{" "}
