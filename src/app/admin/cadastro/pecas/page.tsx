...
export default function CadastroPecas() {
    ...
    if (loading) {
        return (
            <Loading
                fullScreen
                text="Carregando cadastro de peças..."
                size="large"
            />
        );
    }
        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 p-4 pt-6">
            <div className="max-w-7xl mx-auto">
                <div className="bg-white rounded-xl shadow-lg p-6 mb-6 border border-gray-100">
                    ...
                    <p className="text-gray-600 mt-2">Gerencie as peças do sistema</p>
                </div>

                <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                    <p>Conteúdo do cadastro de peças será implementado aqui.</p>
                </div>
            </div>
        </div>
    );
