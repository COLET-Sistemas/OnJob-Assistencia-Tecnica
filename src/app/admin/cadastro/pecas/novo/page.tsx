                    ...
                    <form onSubmit={handleSubmit} className="p-8">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex flex-wrap gap-4">
                                {/* Código da peça */}
                                <div className="w-[20%]">
                                    <label htmlFor="codigo_peca" className="block text-sm font-medium text-[var(--primary)] mb-1">
                                    ...
                                    <input
                                        ...
                                        className={`w-full p-2 border h-[38px] ${formErrors.codigo_peca ? 'border-red-500' : 'border-gray-300'} rounded-md focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent transition-all duration-200 shadow-sm text-black placeholder:text-gray-400`}
                                        placeholder="Ex: RBB-PRFT"
                                    />
                                    {formErrors.codigo_peca && (
                                        <p className="mt-1 text-sm text-red-500">{formErrors.codigo_peca}</p>
                                    )}
                                </div>

                                {/* Descrição */}
                                <div className="flex-1">
                                    <label htmlFor="descricao" className="block text-sm font-medium text-[var(--primary)] mb-1">
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className={`w-full p-2 border h-[38px] ${formErrors.descricao ? 'border-red-500' : 'border-gray-300'} rounded-md focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent transition-all duration-200 shadow-sm text-black placeholder:text-gray-400`}
                                ...
                                {/* Unidade de Medida */}
                                <div className="w-[15%]">
                                    <label htmlFor="unidade_medida" className="block text-sm font-medium text-[var(--primary)] mb-1">
                                    ...
                                    <select
                                        ...
                                        onChange={handleInputChange}
                                        className={`w-full p-2 border h-[38px] ${formErrors.unidade_medida ? 'border-red-500' : 'border-gray-300'} rounded-md focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent transition-all duration-200 shadow-sm text-black appearance-none`}
                                        style={{
                                    ...
                                    {formErrors.unidade_medida && (
                                        <p className="mt-1 text-sm text-red-500">{formErrors.unidade_medida}</p>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-end space-x-4 pt-4 border-t border-gray-200">
                            ...
                            <button
                                type="submit"
                                disabled={savingData}
                                className={`px-4 py-2 bg-[var(--primary)] text-white rounded-md hover:bg-[var(--primary)]/90 transition-colors duration-200 font-medium flex items-center gap-2 ${savingData ? 'opacity-70 cursor-not-allowed' : ''
                                    }`}
                            >
                                <Save size={18} />
